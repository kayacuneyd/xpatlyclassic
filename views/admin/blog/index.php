...
<div class="min-h-screen bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <?php if (empty($posts)): ?>
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-700 mb-2">No blog posts yet</h3>
                    <p class="text-gray-500 mb-4">Create your first blog post to get started.</p>
                    <a href="<?= url('admin/blog/create') ?>" class="btn btn-primary">Create Post</a>
                </div>
            <?php else: ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <div class="font-medium text-gray-900"><?= htmlspecialchars($post['title_en']) ?>
                                            </div>
        ...
        <!-- Back to Dashboard -->
        <div class="mt-6">
            <a href="<?= url('admin') ?>" class="text-gray-600 hover:text-gray-900">
                ← Back to Dashboard
            </a>
        </div>
    </div>
