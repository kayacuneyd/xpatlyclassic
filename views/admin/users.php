            ...
            <form method="GET" action="<?= url('admin/users') ?>" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <select name="role"
                        ...
                        <option value="renter" <?= ($filters['role'] ?? '') === 'renter' ? 'selected' : '' ?>>Renter
                        </option>
                        <option value="owner" <?= ($filters['role'] ?? '') === 'owner' ? 'selected' : '' ?>>Owner</option>
                        <option value="super_admin" <?= ($filters['role'] ?? '') === 'super_admin' ? 'selected' : '' ?>>
                            Super Admin</option>
                        <option value="moderator" <?= ($filters['role'] ?? '') === 'moderator' ? 'selected' : '' ?>>
                            Moderator</option>
                    </select>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            ?>
                                            <span
                                                class="inline-flex px-2 py-0.5 text-xs font-semibold rounded-full <?= $roleColor ?> mt-1">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <?php else: ?>
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-800">
                                                <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd"
